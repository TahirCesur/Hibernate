...
public class H4_Fetch {
	public static void main(String[] args) {
		 ...
		 * 
		 * ------------------------------ L2 CACHE
		 * --------------------------------------- Hibernate L2-cache mekanizmasını da
		 * barındırmaktadır. L2-Cache, default kapalıdır. Kullanmak için aktif hale
		 * getirilmelidir.
		 * 
		 ...
		 * ihtiyac duyarsa bu veri L2'den çekilmiş olur. Yani veritabanına gitmeye gerek
		 * kalmaz.
		 * 
		 */
